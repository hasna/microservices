export interface Subscription {
  id: string; status: string; current_period_end: string;
...
export function canAccess(subscription: Subscription | null, feature: string, planMetadata: Record<string, unknown>): boolean {
