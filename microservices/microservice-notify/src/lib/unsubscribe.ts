...
export async function generateUnsubscribeToken(userId: string, type: string): Promise<string> {
...
export async function verifyUnsubscribeToken(token: string): Promise<{ userId: string; type: string } | null> {
  try {
